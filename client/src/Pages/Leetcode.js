...
const Leetcode = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:5000/leaderboard/leetcode')
  ...
  .sort((a, b) => (b.leetcodeScore || 0) - (a.leetcodeScore || 0)) // Sort descending by score
  .reduce((acc, user) => {
    const last = acc[acc.length - 1];
    const rank = last && last.leetcodeScore === (user.leetcodeScore || 0)
      ...
      <div className="leetcode-content">
        ...
        >
          <div className="leetcode-header-content">
            ...
            <p className="leetcode-subtitle">Track your algorithm progress against peers</p>
          </div>
                      ...
                      <div className="problems-solved">
                        ...
                        <div className="progress-bar">
                          <div 
                            ...
                            style={{ width: `${Math.min(100, (user.leetcodeScore || 0) / 500 * 100)}%` }}
                          ></div>
                        </div>
                      </div>
                    </td>
